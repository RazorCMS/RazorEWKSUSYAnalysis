...
void HggRazorClass::Loop()
{
  ...
  std::ofstream eventListFile;
  if ( this->processName == "data") {
    eventListFile.open( "DiphotonEventList.txt");
  }

  double NEventsMgg230_EBEB = 0;
  double NEventsMgg320_EBEE = 0;
  double NEventsMgg500_EBEB = 0;
  double NEventsMgg500_EBEE = 0;
  ...
  std::cout << "NEventsMgg230_EBEB = " << NEventsMgg230_EBEB  << "\n";
  std::cout << "NEventsMgg320_EBEE = " << NEventsMgg320_EBEE  << "\n";
  std::cout << "NEventsMgg500_EBEB = " << NEventsMgg500_EBEB  << "\n";
