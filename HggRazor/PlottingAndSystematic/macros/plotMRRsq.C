...
void plotMRRsq(string category = "highpt") {
  ...
  tree->Draw("t1Rsq:MR>>MRRsqSignal", ("abs(pho1Eta) <1.44 && abs(pho2Eta)<1.44 && (pho1Pt>40||pho2Pt>40)&&pho1Pt>25 && pho2Pt>25 && pho1passIso && pho2passIso && MR > 150 && t1Rsq >= 0.0 " + categoryCutString + signalRegionCutString).c_str(),"");
