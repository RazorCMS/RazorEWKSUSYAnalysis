...
int main ( int argc, char* argv[] )
{
  ...
  if ( ifs.is_open() )
      ...
      while ( ifs.good() )
	{
	  ...
	  newFile = new TFile( Form("/afs/cern.ch/work/c/cpena/public/combineDiphotonHM/CMSSW_7_4_7/src/eos/eos/cms/store/group/phys_susy/razor/Run2Analysis/HggRazor/2016/V3p12_PhotonCorrDec06_JECSep23V3_20170219/FastsimSignal/combined/SMS-TChiHZ_%s_tweaked_1pb_weighted.root", m1.c_str()), "RECREATE" );
